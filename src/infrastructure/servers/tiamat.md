...
Book, and others. Tiamat uses Caddy to proxy connections to each website and
container.
...
Incoming connections are forwarded to their respective containers using Caddy, which also handles SSL termination and certificates for each project.
