...
[go-talks](https://github.com/COSI-Lab/go-talks) is the latest of several rewrites of Talks. Its source code is located on the COSI [GitLab](https://git.cosi.clarkson.edu/cosi-meta/go-talks).
